		...
		<ul class="side-menu">
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					...
					<li><a class="slide-item" href="{{route('unpaid')}}">الفواتير الغير مدفوعة</a></li>
					<li><a class="slide-item" href="{{route('partial')}}">الفواتير المدفوعة جزئيا</a></li>
					<li><a class="slide-item" href="{{route('archive.index')}}">الارشيف  </a></li>
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{ route('invoices_reports.index') }}">تقارير الفواتير</a></li>
					<li><a class="slide-item" href="{{ route('customers_reports.index') }}">تقارير العملاء</a></li>
